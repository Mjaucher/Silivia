...
object Prefix : Module(
    ...
    private val middleText = group.add(StringSetting.Builder().name("middle-text").defaultValue(Casper.Reference.name).build())
    ...
    override fun onActivate() {
        ...
        ChatUtils.registerCustomPrefix("rainyspring.silivia") { prefixStyle() }
    }
