package silivia.impl.killeffects

import silivia.Silivia
import silivia.utils.world.Spawn
...
class KillEffects : Module(Silivia.Special.Category, "Kill-Effects", "Shows Effects after Death.")
{
